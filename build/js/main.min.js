...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/slider/slider":11,"./modules/tabs/init-tabs":12,"./modules/video/video":14,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
exports.initCoachesSwiper = initCoachesSwiper;
...
function initCoachesSwiper() {
  var coachesSwiper = new _swiper.default('.swiper-coaches', {
    navigation: {
...
function initReviewsSwiper() {
  var reviewsSwiper = new _swiper.default('.reviews__slider-container', {
    navigation: {
...
var videoContainer = document.querySelector('.about__video-container');
var videoPicture = videoContainer.querySelector('.about__poster');
var videoBtn = document.querySelector('.about__button');
